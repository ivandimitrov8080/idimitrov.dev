...
const Links = () => (
  <div className="grid w-max h-max grid-cols-2 grid-rows-2 gap-12 place-content-center absolute right-96 top-[38%]">
    ...
    <Link aria-label="LinkedIn" href={process.env.NEXT_PUBLIC_LINKEDIN_URL || "https://www.linkedin.com/in/devidimitrov"} target="_blank">
