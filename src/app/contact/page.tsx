...
const CheckSvg = () => (
  <svg className="w-8 h-8" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
...
const MailLockSvg = () => (
  <svg className="w-full h-full" width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
...
const Contact = () => (
  <div className="w-full p-7 lg:p-12 grid lg:grid-cols-2 gap-12 basis-full overflow-y-auto overflow-x-hidden">
    <div className="lg:p-12 flex flex-col gap-12 justify-between">
      <div className="flex flex-col gap-4">
        ...
        <p className="flex flex-row gap-2 text-lg lg:text-xl text-white">
          <CheckSvg /> Schedule a consultation
        </p>
        <p className="flex flex-row gap-2 text-lg lg:text-xl text-white">
          <CheckSvg /> Tell me about yourself and your project
        </p>
        <p className="flex flex-row gap-2 text-lg lg:text-xl text-white">
          <CheckSvg /> Get advice for your needs
        </p>
      </div>
      <div className="flex flex-col gap-4">
        <p className="text-lg lg:text-xl text-white">Encrypt your message using my public PGP key</p>
        <a target="_blank" className="w-max px-4 py-2 lg:px-10 rounded-full border-[1px] border-amber-50 z-50" aria-label="PGP key" href="/pgp">
          <span className="flex flex-row gap-4 text-center w-max">
            <div>
              <MailLockSvg />
            </div>
            PGP key
